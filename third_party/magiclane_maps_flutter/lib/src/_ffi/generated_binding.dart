...
class GEMKitFFigen {
  ...
  late final ffi.Pointer<
    ffi.NativeFunction<
      ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Char> p1, ffi.Long p2)
    >
  >
  _native_callPtr =
      _lookup<
  ...
  late final ffi.Pointer<
    ...
    >
  >
  _native_call_createObjectPtr =
      _lookup<
        ffi.NativeFunction<
          ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Char>, ffi.Long)
        >
      >('native_call_createObject');
  late final ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Char> p1, int p2)
  _native_call_createObject = _native_call_createObjectPtr
      .asFunction<ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Char>, int)>();
  ...
  late final ffi.Pointer<
    ffi.NativeFunction<ffi.Void Function(Dart_onNotifyEvent p1)>
  >
  ...
  late final ffi.Pointer<
    ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Char> p1, ffi.Long p2)>
  >
  _native_deleteObjectPtr =
      _lookup<
        ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Char>, ffi.Long)>
      >('native_deleteObject');
  ...
  late final ffi.Pointer<
    ffi.NativeFunction<ffi.Int Function(ffi.Pointer<ffi.Void> p1)>
  >
  ...
  late final void Function(int p1) _set_dart_port = _set_dart_portPtr
